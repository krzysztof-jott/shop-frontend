    ...
    template: `
        <div [formGroup]="parentForm" fxLayout="column">
            ...
            <mat-form-field appearance="fill">
                ...
                <input matInput placeholder="Podaj promocyjną cenę produktu" formControlName="salePrice">
                <div *ngIf="price?.invalid && (salePrice?.dirty || salePrice?.touched)" class="errorMessages">
